...
inline int64_t PastDriftV2(int64_t nTime) { return nTime - 150 * 60; }
...
public:
    ...
    {
        // diot: the coin stake transaction is marked with the first output empty
...
public:
    ...
    // diot: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // diot: two types of block: proof-of-work or proof-of-stake
    ...
    // diot: get max transaction timestamp
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // diot: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // diot: block index flags
    enum  
    {
